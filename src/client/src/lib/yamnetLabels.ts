...
const FALLBACK_LABELS = [
  "Throat clearing", "Speech", "Cough", "Sneeze", "Dog", "Bark", "Cat", "Meow",
  "Door", "Knock", "Glass", "Breaking", "Baby cry, infant cry", "Gargling",
  "Siren", "Alarm", "Vehicle horn, car horn, honking", "Car", "Conversation",
  "Walk, footsteps", "Rain", "Thunderstorm", "Fire", "Explosion", "Gunshot, gunfire",
  "Screaming", "Laughter", "Clapping", "Cheering", "Crowd",
];
  ...
  labelsPromise = (async () => {
    try {
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        const displayName = quoted ? quoted[1].trim() : line.split(",")[2]?.trim() ?? "";
